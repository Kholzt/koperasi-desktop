...
export default class UserController {
    ...
    static async store(req, res) {
        ...
        try {
            const { username, complete_name, role, access_apps, position, status, password, pos_id } = req.body;
    ...
    static async update(req, res) {
        ...
        try {
            const { id } = req.params;
            const { username, complete_name, role, access_apps, position, status, pos_id } = req.body;
