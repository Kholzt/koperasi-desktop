    ...
    return (
        <form onSubmit={handleSubmit(onSubmitForm)} className="bg-white p-6 rounded-lg shadow-sm dark:bg-gray-900">
            <div className="flex justify-between items-center mb-6 border-b pb-3 dark:border-gray-700">
                <h1 className='text-2xl font-semibold text-gray-800 dark:text-white'>Target</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                ...
                <div className="flex flex-col md:col-span-2 bg-gray-50 p-4 dark:border-gray-700 rounded-md border border-gray-200 dark:bg-gray-900">
