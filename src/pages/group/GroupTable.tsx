...
const GroupTable: React.FC<GroupTableProps> = ({ data, pagination, setPaginate }) => {
            ...
            <div className="max-w-full overflow-x-auto">
                <Table>
                    ...
                    <TableBody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
                        {data.map((user: GroupProps, index: number) => (
                            <TableRow key={user.id}>
                                ...
                                <TableCell className="px-4 py-3 text-gray-500 text-start text-theme-sm dark:text-gray-400 capitalize">
                                    <Action id={user.id} group_name={user.group_name} />
                                </TableCell>
                            </TableRow>
                        ))}
...
function Action({ id, group_name }: { id: number, group_name: string }) {
            ...
            <div className="flex flex-col px-2 overflow-y-auto custom-scrollbar normal-case">
                <div>
                    ...
                    <p className="text-base text-gray-800 dark:text-gray-400 ">
                        Apakah Anda yakin untuk menghapus kelompok {group_name}?
                    </p>
